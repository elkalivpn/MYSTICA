...
// Mapa de imágenes de guías REALES desde /guides/
const guideImages: Record<string, string> = {
  'hecate': '/guides/hecate-3d.png',
  'frigg': '/guides/frigg-3d.png',
  'selene': '/guides/selene-3d.png',
  'morpheus': '/guides/morpheus-3d.png',
  'isis': '/guides/isis-3d.png',
  'thoth': '/guides/thoth-3d.png',
  // Fallbacks para otros guías que usan las imágenes existentes
  'pythia': '/guides/hecate-3d.png', // Usa Hécate como fallback
  'astraea': '/guides/selene-3d.png', // Usa Selene como fallback
}

export function MysticGuide3D({ guide, onQuestionSelect, isOpen = true, onClose, compact = false }: MysticGuide3DProps) {
  ...
  const guideImage = guideImages[guide.id] || '/guides/hecate-3d.png'
      ...
      {isOpen && (
        ...
        >
          ...
          <div className={cn("relative", compact ? "p-4" : "p-6")}>
            {/* Header */}
            <div className={cn("flex items-start justify-between mb-4", compact && "mb-3")}>
              <div className="flex items-center gap-4">
                {/* 3D Avatar Image - IMAGEN REAL */}
                <motion.div
                  className={cn(
                    "relative rounded-2xl overflow-hidden guide-float",
                ...
                <div>
                  <motion.h3 
                    ...
                    className={cn("font-bold text-white mb-1 font-mystica", compact ? "text-xl" : "text-2xl")}
                  >
                    {guide.name}
                  </motion.h3>
                  <p className="text-mystica-gold-400 font-medium text-sm">{guide.title}</p>
            ...
            {/* Questions */}
            {!isTyping && !selectedQuestion && !compact && (
              <motion.div
